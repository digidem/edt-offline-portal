...
Esse pub está conectado a alguns "rooms" na Internet, portanto se você seguir o próprio pub você vai poder ver outros usuários (no ssb, os pubs são um tipo especial de usuário - leia mais sobre isso na <a href="http://scuttlebot.io/more/protocols/secure-scuttlebutt.html">documentação</a>)
